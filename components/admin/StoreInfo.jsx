    ...
    return (
        <div className="flex-1 space-y-2 text-sm">
            ...
            <div className="flex items-center gap-2 text-sm ">
                {store.user ? (
                    <>
                        <Image width={100} height={100} src={store.user.image} alt={store.user.name} className="w-9 h-9 rounded-full" />
                        <div>
                    ...
                    <div className="flex items-center gap-2">
                        <div className="w-9 h-9 rounded-full bg-slate-200 flex items-center justify-center text-slate-400">?</div>
                        <p className="text-slate-400 italic">User info unavailable</p>
                    </div>
                )}
            </div>
        </div>
